...
.action-sheet-md .action-sheet-container {
  ...
  background: transparent;//$action-sheet-md-background; kalen.lee@takit.biz
}
...
.action-sheet-md .action-sheet-group {
  ...
  margin-bottom: 8px;  //kalen.lee@takit.biz
  border-radius: 15px; //kalen.lee@takit.biz
  background:#f9f9f9;  //kalen.lee@takit.biz
}

.action-sheet-md .action-sheet-group .button-inner {
  justify-content: center; //kalen.lee@takit.biz
}
